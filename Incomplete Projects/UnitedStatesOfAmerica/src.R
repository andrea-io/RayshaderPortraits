...
# Load Kontur data
US <- st_read("data/kontur_population_US_20220630.gpkg")
...
US_rast <- st_rasterize(US, nx = 3657, ny = 5000)

mat <- matrix(US_rast$population, nrow = floor(size * w_ratio), ncol = floor(size * h_ratio))
